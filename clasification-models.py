...
classifiers = [
    KNeighborsClassifier(3), # Puede variar los params
    SVC(kernel="rbf", C=0.025, probability=True), # Pueden variar los params
    NuSVC(probability=True),
    DecisionTreeClassifier(),
    RandomForestClassifier(n_estimators=100, max_depth=2, random_state=0), # Puede variar los params
    AdaBoostClassifier(),
    ...
    LogisticRegression(),
    MLPClassifier(solver='lbfgs', alpha=1e-5, hidden_layer_sizes=(5, 2), random_state=1) # Puede variar los params
]
